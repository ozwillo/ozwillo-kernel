...
public abstract class AbstractMarketSearchEndpoint {
  ...
  public Response post(
      ...
      @Nullable @FormParam("supported_locale") List<ULocale> supported_locale,
      @Nullable @FormParam("geographical_area") Set<URI> geographical_area,
      @Nullable @FormParam("restricted_area") Set<URI> restricted_area,
