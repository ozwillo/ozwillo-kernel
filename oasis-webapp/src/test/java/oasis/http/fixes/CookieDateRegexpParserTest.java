...
public class CookieDateRegexpParserTest {
  ...
  public static Iterable<Object[]> data() throws IOException {
    ...
    JsonNode examples = mapper.readTree(CookieDateRegexpParserTest.class.getResource("/http-cache/tests/data/dates/examples.json"));
    JsonNode bsdExamples = mapper.readTree(CookieDateRegexpParserTest.class.getResource("/http-cache/tests/data/dates/bsd-examples.json"));
  ...
  @Test public void testParseCookieDate() {
    Date actual = CookieDateRegexpParser.parseCookieDate(input);
